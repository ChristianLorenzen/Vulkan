...
bool Faye::Vulkan::checkValidationLayerSupport() {
    uint32_t layerCount;
...
void Faye::Vulkan::createSurface() {
    window->createWindowSurface(instance, &surface);
}

void Faye::Vulkan::createPhysicalDevice() {
...
void Faye::Vulkan::createLogicalDevice() {
...
bool Faye::Vulkan::isDeviceSuitable(VkPhysicalDevice device) {
...
bool Faye::Vulkan::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
QueueFamilyIndices Faye::Vulkan::findQueueFamilies(VkPhysicalDevice device) {
...
SwapChainSupportDetails Faye::Vulkan::querySwapChainSupport(VkPhysicalDevice device) {
...
uint32_t Faye::Vulkan::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties)
{
...
void Faye::Vulkan::createCommandPools() {
...
VkFormat Faye::Vulkan::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features) {
...
void Faye::Vulkan::createTextureImage()
{
...
VkImageView Faye::Vulkan::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
...
VkCommandBuffer Faye::Vulkan::beginSingleTimeCommands(){
...
void Faye::Vulkan::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
void Faye::Vulkan::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout)
{
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void Faye::Vulkan::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void Faye::Vulkan::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage &image, VkDeviceMemory &imageMemory)
{
...
void Faye::Vulkan::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer &buffer, VkDeviceMemory &bufferMemory)
{
...
void Faye::Vulkan::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size)
{
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void Faye::Vulkan::updateUniformBuffer(uint32_t currentImage) {
