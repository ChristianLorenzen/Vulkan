...
class Engine {
    public: 
    void run() {
        fprintf(stdout, "Init GLFW...\n");
        initGLFW();
        fprintf(stdout, "Init Vulkan...\n");
        initVulkan();
        ...
        createSwapChain();
        fprintf(stdout, "Creating ImageViews...\n");
        createImageViews();
    ...
    VkResult EG_vkCreateInstance(const VkInstanceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkInstance* pInstance) {
    ...
    void initVulkan() {
        ...
        fprintf(stdout, "Creating VKINSTANCE...\n");
    ...
    bool isDeviceSuitable(VkPhysicalDevice device) {
        ...
        if(extensionsSupported) {
            SwapChainSupportDetails swapChainSupport = querySwapChainSuport(device);
            printf("SwapChainSupportDetails: %zu %zu\n", swapChainSupport.formats.size(), swapChainSupport.presentModes.size());
    ...
    SwapChainSupportDetails querySwapChainSuport(VkPhysicalDevice device) {
    ...
    void createSwapChain() {
        SwapChainSupportDetails swapChainSupport = querySwapChainSuport(physicalDevice);
