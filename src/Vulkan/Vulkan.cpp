...
void Faye::Vulkan::createTextureImage()
{
    ...
    stbi_uc* pixels = stbi_load("src/textures/spy.jpg", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
...
VkImageView Faye::Vulkan::createImageView(VkImage image, VkFormat format) {
