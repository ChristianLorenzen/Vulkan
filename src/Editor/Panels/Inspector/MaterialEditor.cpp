...
namespace Faye::Editor::Panels
{
    namespace
    {
                              ...
                              Widgets::TexturePickerPopup *picker)
        {
            ...
            if (!Widgets::subSection(texturesLabel.c_str(), false))
                return;
                                ...
                                Widgets::TexturePickerPopup *picker)
    {
        ...
        Widgets::copyNameToBuffer(materialData.name, nameBuffer);
        ...
        if (Widgets::beginProperties("##materialHeader"))
        {
            Widgets::propertyLabel("Name", handleTooltip.c_str());
            ...
            Widgets::propertyLabel("Shader", shaderTooltip.c_str());
        ...
        if (Widgets::subSection("Properties###materialProperties", false) &&
            Widgets::beginProperties("##materialProperties"))
        {
            if (activeTemplate != nullptr && !activeTemplate->properties.empty())
            {
                ...
                {
                    Widgets::propertyLabel(desc.label.c_str());
            ...
            else
            {
                ...
                Widgets::propertyLabel("Base Color");
                ...
                Widgets::propertyLabel("Alpha Mode");
