...
#include "engine/Scripting/BuiltinScripts/WaterSubdivisionScript.hpp"
...
void Faye::SceneBuilder::populateDefaultScene(Scene &scene)
{
    ...
    if (std::filesystem::exists("src/engine/Scripting/ExampleScripts/rotator.lua"))
    {
        luaScripts.loadScript(secondMeshEntity, "src/engine/Scripting/ExampleScripts/rotator.lua", &scene);
    }
