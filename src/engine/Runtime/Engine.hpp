...
#include "engine/Scripting/ScriptingSystem.hpp"
...
namespace Faye {
    ...
    public:
        ...
        void renderSceneInto(const FrameToken& token, const RenderView& view);
        // Composite the final post-processed scene into the swapchain image.
        void compositeToSwapchain(const FrameToken& token);
        ...
        IRendererBackend&   renderer()          { return *vkData; }
    ...
    private:
        ...
        std::unique_ptr<IRendererBackend> vkData;
