...
namespace Faye
{
  ...
  {
    unmap();
    vmaDestroyBuffer(vk_device.getAllocator(), buffer, allocation);
  }
  ...
  {
    return vmaMapMemory(vk_device.getAllocator(), allocation, &mapped);
  }
  ...
  {
    return vmaFlushAllocation(vk_device.getAllocator(), allocation, offset, size);
  }
  ...
  {
    return vmaInvalidateAllocation(vk_device.getAllocator(), allocation, offset, size);
  }
